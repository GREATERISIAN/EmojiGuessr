...
export declare type FlatCompactEmoji = Omit<CompactEmoji, 'skins'>;
...
export declare type FlatEmoji = Omit<Emoji, 'skins'>;
...
export declare type Locale = 'da' | 'de' | 'en-gb' | 'en' | 'es-mx' | 'es' | 'et' | 'fi' | 'fr' | 'hu' | 'it' | 'ja' | 'ko' | 'lt' | 'ms' | 'nb' | 'nl' | 'pl' | 'pt' | 'ru' | 'sv' | 'th' | 'uk' | 'zh-hant' | 'zh';
